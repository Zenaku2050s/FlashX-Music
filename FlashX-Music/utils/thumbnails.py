...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("FlashX-Music/assets/assets/font2.ttf", 30)
    font = ImageFont.truetype("FlashX-Music/assets/assets/font.ttf", 30)
    title_font = ImageFont.truetype("FlashX-Music/assets/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("FlashX-Music/assets/assets/play_icons.png")
